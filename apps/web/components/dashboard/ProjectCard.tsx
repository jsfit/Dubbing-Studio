...
import { Play, Clock, Film, Trash2, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between group">
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 my-4 bg-slate-50 p-3 rounded-lg border border-slate-100 text-xs">
          <div>
